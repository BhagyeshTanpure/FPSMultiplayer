...
public class PlayerController : MonoBehaviourPunCallbacks
{
    ...
    private void Shoot()
    {
        ...
        if(Physics.Raycast(ray, out RaycastHit hit))
        {
            ...
            {
                // Debug.Log("Hit " + hit.collider.gameObject.GetPhotonView());
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (photonView.IsMine)
        {
            ...
            {
                Debug.Log("Collided");
                photonView.gameObject.transform.position = point2.gameObject.transform.position;
